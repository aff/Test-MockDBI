# Default DBI testing type ("--dbitest" on command line)

# $Id: test-type-default.t 246 2008-12-04 13:01:22Z aff $
...
cmp_ok($md->get_dbi_test_type(), q{==}, 1, q{Expect test mode 1 for '--dbitest'});
